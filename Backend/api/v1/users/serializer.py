...
class PostSerializer(serializers.ModelSerializer):
    author = serializers.StringRelatedField()  # Adjust as needed to display author info

    class Meta:
        model = Posts
        fields = ['id', 'author', 'likes', 'location', 'timestamp', 'description', 'difficulty', 'ingredients', 'is_deleted']
